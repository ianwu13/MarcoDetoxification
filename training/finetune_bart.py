...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_data", default = "../datasets/jigsaw_full_30/train_toxic.csv", help = "Path to train set; ether the toxic or nontoxic split of jigsaw")
    parser.add_argument("--val_data", default = "../datasets/jigsaw_full_30/val_toxic.csv", help = "Path to dev set; same split as above")
    parser.add_argument("--model_dir", default = "../models/toxic")
